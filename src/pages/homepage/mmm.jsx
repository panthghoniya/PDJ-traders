...
const Mmm = () => {
  ...
  return (
    <section className="relative z-20 bg-brand-background py-24 md:py-32" ref={ref}>
      <div className="max-w-[110rem] mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="flex flex-col items-start max-w-2xl">
            {/* Badge */}
            <div data-animate="fade-up" data-delay="100" className="bg-brand-accent text-white px-5 py-1.5 rounded-full text-sm font-semibold tracking-wide mb-8 shadow-sm">
              Service Overview
            </div>
            ...
            {/* Paragraphs */}
            <div data-animate="fade-up" data-delay="350" className="space-y-6 text-brand-dark/70 text-lg md:text-xl leading-relaxed mb-10 font-light">
              <p>
            ...
            <div data-animate="fade-up" data-delay="500">
              <button className="flex items-center gap-6 bg-brand-dark hover:bg-brand-black text-white px-8 py-4 rounded-2xl font-medium transition-all duration-300 group shadow-lg hover:shadow-xl hover:-translate-y-1">
                Ship now
