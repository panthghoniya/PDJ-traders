...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col justify-end overflow-hidden bg-brand-black">
      ...
      <div className="relative z-10 w-full max-w-[110rem] mx-auto px-6 md:px-10 flex flex-col items-start justify-center text-left flex-grow py-32 mt-16 md:mt-0">
        ...
        <div className="flex items-center justify-start gap-4 mb-6 md:mb-8 animate-in fade-in slide-in-from-left-8 duration-700 w-full">
          ...
          <span className="text-brand-accent font-literata font-medium italic tracking-[0.2em] uppercase text-sm md:text-lg">
            WELCOME TO
          </span>
          <div className="h-[2px] w-8 md:w-12 bg-brand-accent"></div>
        </div>
        ...
        {/* Main Title */}
        <h1 
          className="w-full text-left tracking-[2px] md:tracking-[5px] text-white font-bold mb-6 md:mb-8 animate-in fade-in slide-in-from-left-12 duration-1000"
        ...
        {/* Description */}
        <p className="w-full text-left text-brand-light/90 text-base sm:text-lg md:text-xl lg:text-2xl max-w-2xl font-work font-light mb-8 md:mb-12 leading-tight animate-in fade-in slide-in-from-left-12 duration-1000 delay-300">
